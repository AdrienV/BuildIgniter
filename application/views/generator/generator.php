...
<html lang="en">
    <head>
        ...
        <script type="text/javascript">
            ...
            var _gaq = _gaq || [];
            _gaq.push(['_setAccount', 'UA-19087762-10']);
            ...
            $(document).ready(function(){
               $('.codecanyon').click(function(){
                   window.location.replace('http://codecanyon.net/item/mvc-form-generator/4042875?WT.ac=category_thumb&WT.seg_1=category_thumb&WT.z_author=Subshadow');
               }); 
            });
        </script>
    </head>
    <body>
        <header>
            <div class="codecanyon">
                <div>
                <p>
                <img src="<?=base_url()?>assets/img/codecanyon.png" alt="codecanyon" style="width:80px"/>
                </p>
                <p>Buy on CodeCanyon for $10</p>
                </div>
            </div>
